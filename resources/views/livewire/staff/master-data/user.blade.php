...
<x-partials.sidebar position="right" menu="master-data" active="Master Data / Pengguna / Manajemen Akun">
    <x-slot name="action">
    ...
    <flux:modal name="user-modal" class="md:w-96" @close="resetBagAndField">
        <div class="space-y-6">
            ...
            <form wire:submit="store" class="space-y-4">
                ...
                <flux:input label="Konfirmasi Password" wire:model="password_confirmation" type="password"
