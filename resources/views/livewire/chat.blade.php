...
<div class="flex antialiased text-gray-800">
    <div class="flex flex-row h-full w-full">
        ...
        <div class="flex flex-col flex-auto h-[calc(100vh-150px)] px-2">
            ...
            <div class="flex flex-col flex-auto flex-shrink-0 rounded-lg border border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 h-full p-4 mt-2">
                <div class="flex flex-col h-full overflow-x-auto my-4">
                    <div class="flex flex-col h-full">
                        <div class="grid grid-cols-12 gap-y-2">
                            <div class="col-start-1 col-end-8 p-3 rounded-lg">
                                <div class="flex flex-row items-center">
                                    <div class="flex items-center justify-center h-10 w-10 rounded-full bg-accent-content flex-shrink-0">
                                        A
                                    </div>
                ...
                <div class="flex flex-row items-center h-16 rounded-xl bg-white w-full px-2">
                    ...
                    <div class="ml-4">
                        <flux:button variant="primary" class="ml-4" icon:trailing="paper-airplane">Kirim</flux:button>
                    </div>
                </div>
            </div>
        </div>
