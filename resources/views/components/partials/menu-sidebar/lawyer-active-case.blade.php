...
<flux:navlist wire:ignore class=" border border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 p-4 rounded-lg">
    <flux:navlist.group expandable heading="Kemajuan Kasus">
        <flux:navlist.item class="py-5 text-base" :href="route('lawyer.case.page', ['case' => $idDetail, 'status' => 'schedule'])" :current="isset(request()->uri()->pathSegments()[3]) && request()->uri()->pathSegments()[3] === 'schedule' || isset(request()->uri()->pathSegments()[3]) && request()->uri()->pathSegments()[3] === 'meeting-result' || isset(request()->uri()->pathSegments()[3]) && request()->uri()->pathSegments()[3] === 'meeting-documentation'" wire:navigate>
        ...
        <flux:navlist.item class="py-5 text-base" :href="route('lawyer.case.page', ['case' => $idDetail, 'status' => 'court-schedule'])" :current="isset(request()->uri()->pathSegments()[3]) && request()->uri()->pathSegments()[3] === 'court-schedule' || isset(request()->uri()->pathSegments()[3]) && request()->uri()->pathSegments()[3] === 'court-result'" wire:navigate>
