...
<flux:navlist wire:ignore class=" border border-zinc-100 bg-zinc-100 shadow-md dark:border-zinc-700 dark:bg-zinc-900 p-4 rounded-lg">
    <flux:navlist.group expandable heading="Status Kasus">
        ...
        <flux:navlist.item class="py-5 text-base" :href="route('leader.case.validation', ['status' => 'accepted'])" :current="isset(request()->uri()->pathSegments()[3]) && request()->uri()->pathSegments()[3] === 'accepted'" wire:navigate>
        ...
        <flux:navlist.item class="py-5 text-base" :href="route('leader.case.validation', ['status' => 'closed'])" :current="isset(request()->uri()->pathSegments()[3]) && request()->uri()->pathSegments()[3] === 'closed'" wire:navigate>
