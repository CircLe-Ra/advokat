...
<flux:navlist wire:ignore class=" border border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 p-4 rounded-lg">
    <flux:navlist.group expandable heading="Kemajuan Kasus">
        ...
        <flux:navlist.item class="py-5 text-base" :href="route('staff.active.page', ['id' => $idDetail, 'status' => 'schedule'])" wire:navigate>
            <div class="absolute -inset-y-[1px] w-[2px] -start-7 ms-4" ></div>
            Jadwal Sidang
        </flux:navlist.item>
