            ...
            <div>
                ...
                <flux:text class=" p-4">
                    <ol class="list-decimal list-outside">
                        <li>Anda akan menghapus data <b class="text-red-500">{{ $this->$nameData }}</b>.</li>
                        <li>Anda dapat mengembalikan data ini jika diperlukan melalui menu <b>Tempat Sampah</b>.</li>
                    </ol>
                </flux:text>
            </div>
        @else
            <div>
                ...
                <flux:text class=" p-4">
                    <ol class="list-decimal list-outside">
                        <li>Anda akan menghapus data <b class="text-red-500">{{ $this->$nameData }}</b> secara permanen.</li>
