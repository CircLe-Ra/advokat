...
{{--            </div>--}}
            ...
            <span class="text-base font-medium leading-none ml-4">{{ $heading }}</span>
        </button>

        <div class="relative hidden data-open:block space-y-[2px] ps-7" @if ($expanded === true) data-open @endif data-flux-navlist-group-content>
            {{ $slot }}
        </div>
    </ui-disclosure>
<?php elseif ($heading): ?>
